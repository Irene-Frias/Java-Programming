...
public class Lista {
    ...
    public void concatenar(Lista otraLista) {
        int nuevoTamano = tabla.length + otraLista.obtenerTamano();
        tabla = Arrays.copyOf(tabla, nuevoTamano);
        System.arraycopy(otraLista.tabla, 0, tabla,
            tabla.length - otraLista.obtenerTamano(), otraLista.obtenerTamano());
    }
}
